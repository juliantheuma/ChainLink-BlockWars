...
public class PlayerInventory : Inventory
{
    ...
    public void OpenInventory(InputAction.CallbackContext obj)
    {
    ...
    public void OpenInv(){
        Debug.Log("IFTAH!");
        GameObject.Find($"LobbyChar{PlayerPrefs.GetInt("selectedCharacter")}(Clone)").transform.GetChild(0).gameObject.SetActive(false);
        ActivatePanel(true);
        Opened?.Invoke();
        LoadPurchasedItems();
    }
