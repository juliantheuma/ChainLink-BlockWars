...
public class PurchaseItemManager : MonoBehaviour
{
    ...
    public async void PurchaseItem()
    {
        ...
        Debug.Log(_currentItemData.tokenId);
        ...
        Debug.Log("item's price: " + _currentItemData.price);
        
        var result = await PurchaseItemFromContract(_currentItemData.tokenId, metadataUrl, _currentItemData.price);
    ...
    private async Task<string> PurchaseItemFromContract(int tokenId, string metadataUrl, int _price)
    {
        byte[] data = Array.Empty<byte>();
        Debug.Log("Price: " + _price + " $BWC");
